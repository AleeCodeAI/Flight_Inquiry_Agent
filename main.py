...
claude = OpenAI(api_key=openrouter_api_key, base_url=openrouter_url)
gpt = OpenAI(api_key=openrouter_api_key, base_url=openrouter_url)
...
""" 
You are **AeroAssist**, a friendly and reliable flight-information assistant.
